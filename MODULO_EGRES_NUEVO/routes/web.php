...
use App\Http\Controllers\EgresoSolicitudPagoReportController;
...
Route::get('/egresos/solicitud-pago/reporte/{token}', EgresoSolicitudPagoReportController::class)
    ->name('egresos.solicitud-pago.reporte');
