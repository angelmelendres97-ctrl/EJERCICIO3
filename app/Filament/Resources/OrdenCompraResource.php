                                        ...
                                        ->schema([
                                            Wizard::make([
                                                Step::make('Información General')
                                                    ->schema([ProveedorResource::getFormSchema()[0]]),
                                                Step::make('Clasificación')
                                                    ->schema([ProveedorResource::getFormSchema()[1]]),
                                                Step::make('Retención')
                                                    ->schema([ProveedorResource::getFormSchema()[2]]),
                                                Step::make('Información Adicional')
                                                    ->schema([ProveedorResource::getFormSchema()[3]]),
                                                Step::make('Empresas')
                                                    ->schema([ProveedorResource::getFormSchema()[4]]),
                                            ])
                                ...
                                ->schema([
                                    Wizard::make([
                                        Step::make('Conexión e información principal')
                                            ->schema([ProductoResource::getFormSchema()[0]]),
                                        Step::make('Información Producto')
                                            ->schema([ProductoResource::getFormSchema()[1]]),
                                        Step::make('Sucursales y Bodegas Externas')
                                            ->schema([ProductoResource::getFormSchema()[2]]),
                                    ])
