...
class OrdenCompraResource extends Resource
{
    ...
    {
        return app(ExternalConnectionService::class)->getConnectionName($empresaId);
    }

    protected static function getProveedorModalGeneralSection(): Section
    {
            ...
            ->schema([
                ...
                Forms\Components\Select::make('admg_id_empresa')
                    ...
                    ->options(function (Get $get) {
                        ...
                        return app(ExternalConnectionService::class)
                            ->getEmpresasOptions($empresaId);
                    })
                    ->searchable()
                    ->preload()
                    ->live()
                ...
                Forms\Components\Select::make('admg_id_sucursal')
                    ...
                    ->options(function (Get $get) {
                        ...
                        return app(ExternalConnectionService::class)
                            ->getSucursalesOptions($empresaId, $amdgIdEmpresaCode);
                    })
                    ->searchable()
                    ->preload()
                    ->live()
    ...
    protected static function getProveedorModalClasificacionSection(): Section
    {
        return Section::make('Clasificación')
            ->schema([
    ...
    protected static function getProveedorModalCondicionesSection(): Section
    {
        return Section::make('Condiciones de Pago')
            ->schema([
    ...
    protected static function getProveedorModalRetencionSection(): Section
    {
        return Section::make('Retención')
            ->schema([
    ...
    protected static function getProveedorModalInformacionAdicionalSection(): Section
    {
        return Section::make('Informacion Adicional')
            ->schema([
    ...
    protected static function getProveedorModalEmpresasSection(): Section
    {
        return Section::make('Empresas')
            ->schema([
    ...
    protected static function getProductoModalConexionSection(): Section
    {
        return Section::make('Conexión e información principal')
            ->schema([
                Forms\Components\Select::make('id_empresa')
                    ->label('Conexion')
                    ->relationship('empresa', 'nombre_empresa')
                            ...
                            Placeholder::make('search_results')
                                ...
                                ->content(function (Get $get) {
                                    ...
                                    try {
                                        ...
                                        return new \Illuminate\Support\HtmlString($tableHtml);
                                    } catch (\Exception $e) {
    ...
    protected static function getProductoModalInformacionSection(): Section
    {
        return Section::make('Información Producto')
            ->schema([
    ...
    protected static function getProductoModalBodegasSection(): Section
    {
        return Section::make('Sucursales y Bodegas Externas')
            ->schema([
                                    ...
                                    ->schema([
                                        Wizard::make([
                                            Step::make('Información General')
                                                ->schema([self::getProveedorModalGeneralSection()]),
                                            Step::make('Clasificación')
                                                ->schema([self::getProveedorModalClasificacionSection()]),
                                            Step::make('Condiciones de Pago')
                                                ->schema([self::getProveedorModalCondicionesSection()]),
                                            Step::make('Retención')
                                                ->schema([self::getProveedorModalRetencionSection()]),
                                            Step::make('Información Adicional')
                                                ->schema([self::getProveedorModalInformacionAdicionalSection()]),
                                            Step::make('Empresas')
                                                ->schema([self::getProveedorModalEmpresasSection()]),
                                        ])
                                    ])
                                    ...
                                    ->schema([
                                        Wizard::make([
                                            Step::make('Conexión e información principal')
                                                ->schema([self::getProductoModalConexionSection()]),
                                            Step::make('Información Producto')
                                                ->schema([self::getProductoModalInformacionSection()]),
                                            Step::make('Sucursales y Bodegas Externas')
                                                ->schema([self::getProductoModalBodegasSection()]),
                                        ])
                                    ])
